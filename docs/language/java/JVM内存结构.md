...
![JVM内存结构](./JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84.assets/JVM%E5%86%85%E5%AD%98%E6%A8%A1%E5%9E%8B.png)
...
- **字符串常量池**：是JVM针对字符串优化专门开辟的一块区域，避免字符串重复创建。
  - 池中存放的是**字符串对象的引用**，具体对象依然是在堆上。
